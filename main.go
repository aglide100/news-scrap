...
func main() {
	...
	// text := ``
	// text = scrap.Preprocessing(text)
	// docs := strings.Split(text, ".")

	keysents := textrank.TextRankSentences(docs, 2, 0.85, 30, int(float64(len(docs)) * 0.3))
	...
	rank := textrank.TextRankWordGraph(docs, 0.85, 30, 2, 2, 2)
